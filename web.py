...
class Products(db.Model):
    ...
    def __init__(self,pname,pdescript,pkeyword,pstate,puser):
        self.pname=pname
...
@login_required
def followee():
    return render_template('followee.html')
...
def addproduct():
    if request.method == 'POST':
        ...
        # store in database
           ...
           # pstate='sell'
            new_product = Products(request.form['pname'],request.form['pdescript'], request.form['pkeyword'],request.form['pstate'],puser=puser)
